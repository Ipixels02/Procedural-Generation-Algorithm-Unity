...
public class TilemapVisualizer : MonoBehaviour
{
    ...
    //private TileBase[] floortiles = new TileBase[];
    [SerializeField]
    private List<TileBase> FloorTiles;
    //public int FloorTilesCount = 5;
    //public GameObject FloorTiles;
    //public GameObject[] FloorTiles;

    public void PaintFloorTiles(IEnumerable<Vector2Int> floorPositions) //Отрисовка тайлов пола
    {
        PaintTiles(floorPositions, floorTilemap, floorTile);
    }

    private void PaintTiles(IEnumerable<Vector2Int> positions, Tilemap tilemap, TileBase tile) // отрисовка тайлов
    {
